  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: ClientOutcome_Page(
        title: "Incident Response Participants' Outcome Page",
        room: room,
      ),
    );
  }
                ...
                if (!isCollapsed) ...[
                  ...
                  const Padding(
                    ...
                    child: Text(
                      ...
                      "In the bottom right corner lies a 'Leave Room' button to push once you have finished going over the feedback. \n\n",
                      style: TextStyle(
                          fontSize: 15,
